...
<table width="100%" border="0" cellpadding=0 cellspacing=0
    ...
    @foreach($products as $product)
        <tr>
            ...
            <td class="b_left b_top">{{ $product['product_amount'] }}</td>
            ...
            ?>
            <td class="b_left b_top">{{ $sumWithoutNds }}</td>
            <td class="b_left b_top">&nbsp;</td>
            <td class="b_left b_top">18</td>
            <td class="b_left b_top">{{ $nds }}</td>
            <td class="b_left b_top">{{ $sumWithNds }}</td>
...
<table cellpadding="0" cellspacing="0" border="0"
    ...
    <tr>
        ...
        <td class=underlined>&nbsp;</td>
        <td style="width: 5mm">&nbsp;</td>
        <td class="underlined nobr" style="width: 45mm"><b>{{ $selfFirm->accountant_fio }}</b></td>
    </tr>
    <tr>
        <td>&nbsp;</td>
