            ...
            <div class="sub-page-left">
                ...
                <div class="wrap">
                    <div class="extra-wrap">
                        ...
                        <p>На нашем сайте вы можете приобрести колесные пары, боковые рамы, надрессорные балки и прочие детали вагонов. Все запчасти, представленные в {!! link_to_route('trainCar','каталоге сайта') !!}, есть в наличии, и будут отгружены покупателю в течение максимум трех дней после оплаты счета. Условия поставки отражены в <a href="#">договоре оферты</a>.</p>
                        <br>
