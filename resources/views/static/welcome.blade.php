    ...
    <section id="content"><div class="ic"></div>
        <div class="block-1 box-1">
            ...
            <div>
                ...
                <a href="{{ URL::route('trainCarService') }}"><p class="text-1">Услуги для грузовых вагонов</p></a>
                <p>Мы предоставляем немалый спектр услуг. От инструментального обмера вагонов до организации отстоя вагонов.</p>
            </div>
        </div>
