                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        @else
                            ...
                            <p><b>Внимание!!!</b> Если счет не будет оплачен через 3 дня, заказ будет анулирован</p>
                        @endif
                        <p>Увидеть подробную информацию о своих заказах и документах, Вы можете в разделе {!! link_to_route('cabinet','Личный кабинет') !!}</p>
                        <hr>
                    </div>
                </div>
            </div>
